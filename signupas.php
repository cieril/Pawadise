...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($checkResult->num_rows > 0) {
            ...
            $insertQuery = "INSERT INTO admins (username, pwd) VALUES (?, ?)";
...
<body>
    ...
    <div class="wrapper_signup">
        <form action="signupas.php" method="post">

            <img class="logo" src="images/PAWADISE.png" alt="">

            <p><b> ADMIN SIGN UP </b></p>
            ...
            <div class="create_account">
                Have an account? <a href="loginas.php"> Login </a>
            </div>
