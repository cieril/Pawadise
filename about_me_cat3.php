    ...
    <main>
        ...
        <section class="cat_dog">
            <div class="grid_aboutme">
                <div class="aboutme_item"> <img src="images/Cat_3.jpg" alt=""> </div>
                <div class="aboutme_item"> 
                    
                <p style="text-align: center;"> <b> Lucas </b> </p> 
                ...
                <p class="description">
                    <b>Gender:</b> Male <br>
                    <b>Age:</b> Adult <br>
                    <b>Colour:</b> Gray, White <br>
                    <b>Description:</b> Love to sleep on bed
                </p>
