...
<body>
    ...
    <main>
        ...
        <section class="cat_dog">
            <div class="grid_aboutme">
                <div class="aboutme_item"> <img src="images/Cat_4.jpg" alt=""> </div>
                <div class="aboutme_item"> 
                    
                <p style="text-align: center;"> <b> Loonie </b> </p> 
                ...
                <p class="description">
                    <b>Gender:</b> Male <br>
                    <b>Age:</b> Adult <br>
                    <b>Colour:</b> Orange, White <br>
                    <b>Description:</b> Love to eat and sleep, gentle feline
                </p>

                <a class="inquiry" href="https://forms.gle/p71Q54L8YFXhhRWx8"> ADOPTION INQUIRY </a>
