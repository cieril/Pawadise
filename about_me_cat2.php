    ...
    <main>
        ...
        <section class="cat_dog">
            <div class="grid_aboutme">
                <div class="aboutme_item"> <img src="images/Cat_2.jpg" alt=""> </div>
                <div class="aboutme_item"> 
                    
                <p style="text-align: center;"> <b> Orange </b> </p> 
                ...
                <p class="description">
                    ...
                    <b>Age:</b> Kitten <br>
                    <b>Colour:</b> Orange <br>
                    <b>Description:</b> Energetic, loves playtime
                </p>
